...
export type BlnkRequest = <T, R>(endpoint: string, data: T, method: `POST` | `GET` | `PUT` | `DELETE`, headerOptions?: Record<string, string>) => Promise<ApiResponse<R | null>>;
export interface ServiceConstructor {
    new (request: BlnkRequest, logger: BlnkLogger, formatResponse: FormatResponseType): unknown;
}
...
export type HandleErrorType = (error: unknown, logger: BlnkLogger, formatResponse: FormatResponseType) => ApiResponse<null>;
