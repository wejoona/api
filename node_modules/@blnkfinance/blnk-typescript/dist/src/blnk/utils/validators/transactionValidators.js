...
exports.ValidateCreateTransactions = ValidateCreateTransactions;
exports.ValidateUpdateTransactions = ValidateUpdateTransactions;
const stringUtils_1 = require("../stringUtils");
const ledgerBalance_1 = require("./ledgerBalance");
function ValidateCreateTransactions(data) {
    ...
    if (!(0, stringUtils_1.IsValidString)(data.currency)) {
...
function ValidateUpdateTransactions(data) {
