...
const transactionValidators_1 = require("../utils/validators/transactionValidators");
/**
...
class Transactions {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const validatorResponse = (0, transactionValidators_1.ValidateCreateTransactions)(data);
                if (validatorResponse) {
                    return this.formatResponse(400, validatorResponse, null);
                }
                const response = yield this.request(`transactions`, data, `POST`);
    ...
    updateStatus(id, update) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validatorResponse = (0, transactionValidators_1.ValidateUpdateTransactions)(update);
                if (validatorResponse) {
                    return this.formatResponse(400, validatorResponse, null);
                }
                const response = yield this.request(`transactions/inflight/${id}`, update, `PUT`);
                return response;
            }
            catch (error) {
                return (0, logger_1.HandleError)(error, this.logger, this.formatResponse, this.updateStatus.name);
            }
        });
    }
    /**
    ...
    refund(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.request(`refund-transaction/${id}`, null, `POST`);
                return response;
            }
            catch (error) {
                return (0, logger_1.HandleError)(error, this.logger, this.formatResponse, this.refund.name);
            }
        });
    }
}
