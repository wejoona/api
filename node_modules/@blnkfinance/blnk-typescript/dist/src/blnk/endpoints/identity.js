...
const identityValidators_1 = require("../utils/validators/identityValidators");
/**
 ...
 */
class Identity {
    constructor(request, logger, formatResponse) {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validatorResponse = (0, identityValidators_1.ValidateIdentity)(data);
                if (validatorResponse) {
                    return this.formatResponse(400, validatorResponse, null);
                }
                const response = yield this.request(`identities`, data, `POST`);
                return response;
            }
            catch (error) {
                return (0, logger_1.HandleError)(error, this.logger, this.formatResponse, this.create.name);
            }
        });
    }
    /**
    ...
    get(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.request(`identities/${id}`, null, `GET`);
                return response;
            }
            catch (error) {
                return (0, logger_1.HandleError)(error, this.logger, this.formatResponse, this.get.name);
            }
        });
    }
    /**
    ...
    list() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.request(`identities`, null, `GET`);
                return response;
            }
            catch (error) {
                return (0, logger_1.HandleError)(error, this.logger, this.formatResponse, this.list.name);
            }
        });
    }
    /**
    ...
    update(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield this.request(`identities/${id}`, data, `PUT`);
                return response;
            }
            catch (error) {
                return (0, logger_1.HandleError)(error, this.logger, this.formatResponse, this.update.name);
            }
        });
    }
}
