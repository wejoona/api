...
const balanceMonitors_1 = require("../utils/validators/balanceMonitors");
/**
...
class BalanceMonitor {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validatorResponse = (0, balanceMonitors_1.ValidateMonitorData)(data);
                if (validatorResponse) {
                    return this.formatResponse(400, validatorResponse, null);
                }
                //add meta_data to this type
                const response = yield this.request(`balance-monitors`, data, `POST`);
                return response;
            }
            catch (error) {
    ...
    get(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.request(`balance-monitors/${id}`, undefined, `GET`);
                return response;
            }
            catch (error) {
    ...
    list() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.request(`balance-monitors`, undefined, `GET`);
                return response;
            }
            catch (error) {
                return (0, logger_1.HandleError)(error, this.logger, this.formatResponse, this.get.name);
    ...
    update(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield this.request(`balance-monitors/${id}`, data, `PUT`);
                return response;
            }
            catch (error) {
