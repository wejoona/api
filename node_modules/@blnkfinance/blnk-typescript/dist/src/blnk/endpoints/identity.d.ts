...
export declare class Identity {
     ...
     */
    create<T extends Record<string, unknown>>(data: IdentityData<T>): Promise<import("../../types/general").ApiResponse<IdentityDataResponse<T> | null>>;
    /**
     ...
     */
    get<T extends Record<string, unknown>>(id: string): Promise<import("../../types/general").ApiResponse<IdentityDataResponse<T> | null>>;
    /**
     ...
     */
    list(): Promise<import("../../types/general").ApiResponse<IdentityDataResponse<Record<string, unknown>>[] | null>>;
    /**
     ...
     * });
     */
    update<T extends Record<string, unknown>>(id: string, data: IdentityData<T>): Promise<import("../../types/general").ApiResponse<IdentityDataResponse<T> | null>>;
}
