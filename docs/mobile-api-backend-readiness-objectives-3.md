...
- [ ] Add endpoint-level negative-path e2e coverage for representative unavailable, forbidden ownership, insufficient funds, invalid PIN, and missing wallet envelopes.
