...
- [x] Replace any mobile fake transaction/balance fields with API-backed fields or explicit unavailable states.
...
- [x] Confirm push setup fallback does not block in-app notification usage.
