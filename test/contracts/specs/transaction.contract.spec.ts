        ...
        transactions: [
          {
            ...
            supportReference: '123e4567-e89b-12d3-a456-426614174000',
        ...
        transactions: [
          {
            ...
            counterpartyPhone: null,
            direction: 'credit',
            externalReference: 'yc_dep_1234567890',
            supportReference: '123e4567-e89b-12d3-a456-426614174000',
            ledgerReference: 'ledger-dep-123',
            providerReference: 'yc_dep_1234567890',
            createdAt: '2026-01-18T12:00:00.000Z',
            completedAt: '2026-01-18T12:05:00.000Z',
            metadata: {
              sourceCurrency: 'XOF',
        ...
        transactions: [
          {
            ...
            status: 'completed',
            description: null,
            counterpartyName: 'Fatou Traore',
            counterpartyPhone: '+2250707654321',
            direction: 'credit',
            externalReference: 'ledger-int-456',
            supportReference: '123e4567-e89b-12d3-a456-426614174000',
            ledgerReference: 'ledger-int-456',
            providerReference: null,
            createdAt: '2026-01-18T12:00:00.000Z',
            completedAt: '2026-01-18T12:00:01.000Z',
            metadata: {
        ...
        transactions: [
          {
            ...
            counterpartyPhone: null,
            direction: 'debit',
            externalReference: 'provider-ext-123',
            supportReference: '123e4567-e89b-12d3-a456-426614174000',
            ledgerReference: 'ledger-ext-123',
            providerReference: 'provider-ext-123',
            createdAt: '2026-01-18T12:00:00.000Z',
            completedAt: null,
            metadata: {
