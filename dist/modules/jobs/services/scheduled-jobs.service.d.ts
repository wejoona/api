...
export declare class ScheduledJobsService {
    ...
    constructor(transactionRepository: Repository<TransactionOrmEntity>, jobRepository: Repository<ScheduledJobEntity>, auditLogRepository: Repository<AuditLogEntity>);
    ...
    triggerJob(jobName: 'expire_stale_transactions' | 'cleanup_transaction_metadata' | 'cleanup_audit_logs' | 'daily_reconciliation'): Promise<{
        message: string;
    }>;
}
