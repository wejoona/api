...
import { InitiateDepositDto, InternalTransferDto, ExternalTransferDto, GetRateDto, SubmitKycDto, VerifyPinDto, SetPinDto, WithdrawDto } from '../dto/requests';
import { GetBalanceUseCase, GetDepositChannelsUseCase, InitiateDepositUseCase, InternalTransferUseCase, ExternalTransferUseCase, GetRateUseCase, SubmitKycUseCase, GetKycStatusUseCase, VerifyPinUseCase, SetPinUseCase, CreateWalletUseCase } from '../usecases';
export declare class WalletController {
    ...
    createWallet(req: AuthenticatedRequest): Promise<{
        ...
        currency: string;
        balance: number;
        status: import("../../domain/entities/wallet.entity").WalletStatus;
    }>;
