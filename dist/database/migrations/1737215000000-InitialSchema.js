...
exports.InitialSchema1737215000000 = void 0;
class InitialSchema1737215000000 {
    constructor() {
        this.name = 'InitialSchema1737215000000';
    }
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_wallets_yellow_card_wallet_id" ON "wallets" ("yellow_card_wallet_id")`);
        await queryRunner.query(`
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_transactions_yellow_card_ref" ON "transactions" ("yellow_card_ref")`);
...
exports.InitialSchema1737215000000 = InitialSchema1737215000000;
//# sourceMappingURL=1737215000000-InitialSchema.js.map